...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, u as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, b as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, d as RequestStatusDoneNoReplyErrorCode, e as RejectError, f as CertifiedRejectErrorCode, g as UNREACHABLE_ERROR, I as InputError, h as InvalidReadStateRequestErrorCode, i as ReadRequestType, k as Principal, m as IDL, n as MissingCanisterIdErrorCode, H as HttpAgent, o as encode, Q as QueryResponseStatus, p as UncertifiedRejectErrorCode, q as isV3ResponseBody, s as isV2ResponseBody, t as UncertifiedRejectUpdateErrorCode, v as UnexpectedErrorCode, w as decode, S as Subscribable, x as pendingThenable, y as resolveEnabled, z as shallowEqualObjects, A as resolveStaleTime, D as noop$1, F as environmentManager, G as isValidTimeout, J as timeUntilStale, K as timeoutManager, L as focusManager, N as fetchState, O as replaceData, V as notifyManager, W as hashKey, X as getDefaultState, r as reactExports, Y as shouldThrowError, Z as useQueryClient, _ as useInternetIdentity, $ as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, a as cn, a0 as Primitive, a1 as createContextScope, a2 as React, a3 as useComposedRefs, a4 as createSlot, a5 as reactDomExports, a6 as Primitive$1, a7 as useLayoutEffect2, a8 as useCallbackRef, a9 as useControllableState, aa as useId, ab as composeEventHandlers, ac as Portal$1, ad as hideOthers, ae as useFocusGuards, af as ReactRemoveScroll, ag as FocusScope, ah as DismissableLayer, ai as Record, aj as Service, ak as Func, al as Vec, am as Int, an as Text, ao as Nat, ap as Phone, aq as Mail, ar as MapPin, B as Button, as as ue } from "./index-CJPdjnfJ.js";
import { c as ChevronDown, m as motion, B as Badge, C as CircleCheck } from "./proxy-DAhBn7IP.js";
...
Service({
  "listContactSubmissions": Func(
    [],
    [Vec(ContactSubmission)],
    ["query"]
  ),
  "submitContactForm": Func([ContactInput], [ContactSubmission], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const ContactId2 = IDL2.Nat;
  const Timestamp2 = IDL2.Int;
  const ContactSubmission2 = IDL2.Record({
    "id": ContactId2,
    "service_interest": IDL2.Text,
    "name": IDL2.Text,
    "email": IDL2.Text,
    "message": IDL2.Text,
    "phone": IDL2.Text,
  ...
  return IDL2.Service({
    "listContactSubmissions": IDL2.Func(
      [],
      [IDL2.Vec(ContactSubmission2)],
      ["query"]
    ),
    "submitContactForm": IDL2.Func([ContactInput2], [ContactSubmission2], [])
  });
};
class Backend {
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "contact.page", className: "py-16 bg-background min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-accent/12 text-accent border-accent/25", children: "Contact Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl sm:text-5xl font-bold text-foreground mb-4", children: "Let's Build Something Together" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto text-lg", children: "Have a project in mind? Reach out and our team will get back to you within 24 hours." })
        ]
      }
    ),
          ...
          children: [
            [
              ...
              },
              {
                icon: MapPin,
                label: "Address",
                value: "Baher Madi Bazar, Daulatpur Thana, Kushtia District, Bangladesh",
                href: void 0,
                sub: "Visit by appointment"
              }
            ].map(({ icon: Icon2, label, value, href, sub }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-accent/12 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-accent" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-xl bg-primary/6 border border-primary/15", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground", children: "Fast Response" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "We typically respond to all inquiries within 24 business hours. For urgent matters, please call directly." })
            ] })
          ]
        }
      ),
        ...
        motion.div,
        {
          ...
          children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/15 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-8 h-8 text-accent" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-foreground mb-3", children: "Message Sent!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6 max-w-sm", children: "Thank you for reaching out. We'll review your message and get back to you within 24 hours." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
              ...
              children: [
                        ...
                        render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          Select,
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: SERVICE_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: opt, children: opt }, opt)) })
                            ]
                          }
                        )
                      }
                    ),
                    errors.service_interest && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        "data-ocid": "contact.service_field_error",
                        className: "text-xs text-destructive mt-1",
                        children: errors.service_interest.message
                      }
                    )
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "message", className: "text-sm font-medium", children: [
                    "Project Details ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: isSubmitting || mutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                mutation.isError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Something went wrong. Please try again or call us at 01728065402."
                  }
                )
              ]
            }
